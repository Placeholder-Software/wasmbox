...
Addressable loading is an **optional** feature of Wasmbox which automatically handles the process of loading a `WasmAsset`. To use it, `Addressables` must [be installed](http://localhost:3000/wasmbox/getting_started/installation/#addressables) from the package manager.
